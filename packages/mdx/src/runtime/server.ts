import { type MetaData, type PageData, type Source, type VirtualFile } from '@watanuki/core/source';
...
interface ToWatanukiSourceOptions {
...
> {
  ...
  toWatanukiSource: (options?: ToWatanukiSourceOptions) => Source<{
  ...
  return {
    ...
    > {
      const entry = {
        ...
        toWatanukiSource(options) {
          return toWatanukiSource(this.docs, this.meta, options);
        },
