...
import {
  ...
  SchemaProvider,
  useResolvedSchema,
} from '@watanuki/api-docs/components/playground/schema';
import {
  Select,
  SelectContent,
  SelectItem,
...
import { labelVariants } from '@watanuki/api-docs/components/input';
...
import { Spinner } from '@watanuki/api-docs/components/spinner';
import { joinURL, resolveServerUrl } from '@watanuki/api-docs/utils/url';
import { NoReference } from '@watanuki/api-docs/schema';
...
export interface PlaygroundClientOptions {
   ...
   * - the `Custom.useController()` from `@watanuki/openapi/playground/client`.
   *
