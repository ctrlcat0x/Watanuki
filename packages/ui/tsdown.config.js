...
export default defineConfig({
    ...
    exports: {
        ...
        customExports: {
            './style.css': {
                style: './css/generated/ui.css',
                default: './css/generated/ui.css',
            },
            './css/*': './css/*',
            './mdx': {
                types: './dist/mdx.d.ts',
...
export async function compileInline() {
    ...
    for (const layout of layouts) {
        ...
        await writeFile(`css/generated/${layout}.css`, namesToFile(scanner.scan().filter((name) => !commonNameSet.has(name))));
    }
    console.log('generated CSS files');
}
function namesToFile(names) {
