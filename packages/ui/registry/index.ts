...
export const registry: Registry = {
  ...
  components: [
    ...
    {
      name: 'media',
      description: 'Auto-detecting image, GIF, audio, and video player',
      files: [
        {
          type: 'components',
          path: 'components/media.tsx',
        },
      ],
    },
    {
