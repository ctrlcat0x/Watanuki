...
export function TOC({ container, header, footer, style = 'normal', list }: TOCProps) {
  ...
  return (
    <div
      ...
      {...container}
      className={cn(
        'sticky top-(--fd-docs-row-3) [grid-area:toc] h-[calc(var(--fd-docs-height)-var(--fd-docs-row-3))] flex flex-col w-(--fd-toc-width) pt-6 px-4 pb-2 xl:layout:[--fd-toc-width:268px] max-xl:hidden',
        container?.className,
      )}
    >
      {header}
