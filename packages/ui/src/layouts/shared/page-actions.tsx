...
export function ViewOptionsPopover({
  ...
  return (
    <Popover>
      ...
      >
        <BookOpenText className="size-3.5 text-fd-muted-foreground" />
...
export function PagePagerButtons(props: ComponentProps<'div'>) {
  ...
  return (
    <div {...props} className={cn('inline-flex items-center gap-2', props.className)}>
      {items.previous && (
        <Link
          href={items.previous.url}
          aria-label={`Previous page: ${items.previous.name}`}
          className={buttonVariants({ color: 'secondary', size: 'sm', className: 'w-9 px-0' })}
        >
      ...
      {items.next && (
        <Link
          href={items.next.url}
          aria-label={`Next page: ${items.next.name}`}
          className={buttonVariants({ color: 'secondary', size: 'sm', className: 'w-9 px-0' })}
        >
