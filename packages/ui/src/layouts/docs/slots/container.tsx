...
export function Container(props: ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      className={cn(
        'overflow-x-clip min-h-(--fd-docs-height) [--fd-docs-height:100dvh] [--fd-header-height:0px] [--fd-toc-popover-height:0px] max-lg:[--fd-sidebar-width:0px] max-lg:[--fd-toc-width:0px] data-[column-changed=true]:transition-[grid-template-columns]',
        props.className,
      )}
    >
      {props.children}
