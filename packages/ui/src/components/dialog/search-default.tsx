...
import { SearchClient, useDocsSearch } from '@watanuki/core/search/client';
...
export interface DefaultSearchDialogProps extends SharedProps {
  /** @deprecated re-create the dialog instead for other clients, see https://watanuki.dev/docs/search/orama */
  type?: 'static';
