...
export function TOCItems({ ref, className, thumbBox = true, children, ...props }) {
    ...
    const onPrint = useCallback(() => {
        ...
        output.unshift(_jsx("path", { d: d, className: "stroke-fd-primary", strokeWidth: "1", fill: "none" }, "path"));
        ...
        if (thumbBox) {
            ...
            for (let i = 0; i < positions.length; i++) {
                ...
                while (l < n && path.getPointAtLength(l).y < top)
                    l++;
    ...
    return (_jsxs("div", { ref: mergeRefs(containerRef, ref), className: cn('relative flex flex-col', className), ...props, children: [svg && _jsx(ThumbTrack, { computed: svg, thumbBox: thumbBox }), children] }));
}
...
function ThumbTrack({ computed, thumbBox }) {
    ...
    return (_jsxs("div", { ref: ref, className: "absolute top-0 inset-s-0 origin-center rtl:-scale-x-100", style: {
            ...
            ...calculate(tocInfo.get()),
                ...
                }, children: computed.content }), thumbBox && (_jsx("div", { className: "absolute left-0 size-1 bg-fd-primary rounded-full [offset-distance:var(--offset-distance,0)] opacity-(--opacity,0) transition-[opacity,offset-distance]", style: {
    ...
    const { isFirst, isLast, svg } = useMemo(() => {
        ...
        return {
            ...
            svg: (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", className: cn('absolute -top-1.5 inset-s-0 bottom-0 h-[calc(100%+--spacing(1.5))] -z-1 rtl:-scale-x-100', l1 !== l2 && 'h-full bottom-1.5'), style: {
                ...
                }, children: [l0 !== l1 && (_jsx("path", { d: `M ${l0 + 0.5} 0 C ${l0 + 0.5} 8 ${l1 + 0.5} 4 ${l1 + 0.5} 12`, stroke: "black", strokeWidth: "1", fill: "none", className: "stroke-fd-foreground/10" })), _jsx("line", { x1: l1 + 0.5, y1: l0 === l1 ? '6' : '12', x2: l1 + 0.5, y2: "100%", strokeWidth: "1", className: "stroke-fd-foreground/10" }), item._step !== undefined && (_jsxs("g", { transform: `translate(${l1 + 0.5}, ${l1 === l2 ? '3' : '6'})`, children: [_jsx("circle", { cx: "0", cy: "50%", r: "8", className: "fill-fd-muted" }), _jsx("text", { x: "0", y: "50%", textAnchor: "middle", alignmentBaseline: "central", dominantBaseline: "middle", className: "fill-fd-muted-foreground font-medium text-xs leading-none font-mono rtl:-scale-x-100", children: item._step })] }))] })),
        };
    }, [items, item]);
    return (_jsxs(Primitive.TOCItem, { href: item.url, ...props, className: cn('prose relative py-1.5 text-sm scroll-m-4 text-fd-muted-foreground hover:text-fd-accent-foreground transition-colors wrap-anywhere data-[active=true]:text-fd-primary', isFirst && 'pt-0', isLast && 'pb-0', props.className), style: {
