...
export function HeadlessCodeBlock(props) {
    return _jsx(CodeBlockShell, { ...props, title: undefined, actionsPlacement: "overlay" });
}
export function CodeBlock(props) {
    return _jsx(CodeBlockShell, { ...props });
}
function CopyButton({ className, containerRef, ...props }) {
    ...
    return (_jsx("button", { type: "button", "data-checked": checked || undefined, className: cn(buttonVariants({
            ...
            size: 'icon-xs',
        }), className), "aria-label": checked ? t('Copied Text', { note: 'aria-label' }) : t('Copy Text', { note: 'aria-label' }), onClick: onClick, ...props, children: checked ? _jsx(Check, {}) : _jsx(Clipboard, {}) }));
}
